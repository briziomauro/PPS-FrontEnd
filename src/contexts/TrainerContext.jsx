...
const fetchTrainerDetails = async () => {
    const response = await fetch("https://localhost:7179/api/Trainer/GetMyDetails", {
        method: "GET",
        headers: {
...
export const TrainerProvider = ({ children }) => {
    ...
    const { data: trainerDetails, error, isLoading } = useQuery({
    ...
    return (
        <TrainerContext.Provider value={{ trainerDetails, error, isLoading }}>
            {children}
