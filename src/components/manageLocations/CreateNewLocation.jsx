            ...
            <div className="modal-box rounded-md items-center w-[500px] h-[450px] bg-gradient-to-br from-black via-zinc-900 to-black">
                ...
                <form className='flex flex-col justify-evenly' onSubmit={handleNewLocation}>
                    ...
                    <div className="flex justify-end text-white mt-3">
                        <button
                            type="submit"
                            className="px-4 py-2 m-1 bg-yellow-500 text-xl rounded-xl hover:scale-105 transition-all duration-300 text-white font-bebas flex gap-2 p-4 items-center"
                        >
